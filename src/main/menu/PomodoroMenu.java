...
/**
 * Kelas ini menampilkan menu tentang Teknik Pomodoro.
 * Menu ini akan menampilkan penjelasan tentang Teknik Pomodoro dan
 * langkah-langkahnya.
 */
public class PomodoroMenu {
  ...
  /**
   * Menampilkan menu tentang Teknik Pomodoro.
   * Menu ini akan menampilkan penjelasan tentang Teknik Pomodoro dan
   * langkah-langkahnya.
   */
  public void display() {
    ...
    // Menampilkan penjelasan tentang Teknik Pomodoro
    ...
    // Menampilkan langkah-langkah Teknik Pomodoro
    ...
    // Menanyakan apakah pengguna ingin kembali ke menu utama
    System.out.print("Kembali ke menu utama? (y/n): ");
    String input = scanner.nextLine().trim().toLowerCase();
    if (input.equalsIgnoreCase("y")) {
      new MainMenu().display(); // Kembali ke menu utama
    }
  }
}
